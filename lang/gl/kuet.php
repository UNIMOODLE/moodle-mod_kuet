...
$string['httpsrecommended'] = 'Usa o protocolo HTTP. Recoméndase encarecidamente utilizar o protocolo https en ambientes de PRODUCIÓN.';
$string['protocolnotvalid'] = 'Debe usar HTTP ou HTTPS, e recoméndase encarecidamente que o use na plataforma para executar Kuet.';
$string['sessionsnum'] = 'Número de sesións';
$string['validopenconnection'] = 'Conexión válida cun servidor WebSocket.';
$string['invalidconnection'] = 'Os teus usuarios non poden establecer unha conexión válida co teu servidor WebSocket. Investiga se o teu URL é válido ou investiga se o teu porto está aberto e acepta conexións.';
$string['tests'] = 'Proba';
$string['results'] = 'Resultado';
$string['protocoltest'] = 'Protocolo';
$string['protocoltest_description'] = 'Comproba se o protocolo é http ou https';
$string['ssltest'] = 'Certificado SSL';
$string['ssltest_description'] = 'Comproba se o certificado SSL é válido';
$string['openconnectiontest'] = 'Conexión co servidor WebSocket';
$string['openconnectiontest_description'] = 'Comprobe se os seus usuarios poden establecer conexión co servidor WebSocket';
$string['test_info'] = 'Información de proba';
$string['test_description'] = 'Quen comproba';
$string['extra_info'] = 'Información adicional (se existe)';
$string['userconnectionsonrisk'] = 'Os teus usuarios corren un risco porque as súas conexións non están cifradas.';
$string['sendmessagetest'] = 'Enviar mensaxe';
$string['sendmessagetest_description'] = 'Enviar mensaxe ao servidor WebSocket';
$string['validsendedtest'] = 'A mensaxe foi enviada correctamente.';
$string['invalidsendedtest'] = 'Mensaxe enviada incorrectamente';
$string['receivemessagetest'] = 'Recibir resposta de mensaxe';
$string['receivemessagetest_description'] = 'Reciba a resposta da mensaxe do servidor WebSocket';
$string['validreceivedtest'] = 'Mensaxe recibiu incorrectamente.';
$string['invalidreceivedtest'] = 'Mensaxe recibida incorrectamente';
$string['nodatareceivedtest'] = 'Parece que hai un erro entre a conexión do servidor e o cliente.';
$string['socketurl'] = 'O URL do servidor de WebSocket é: ';
$string['runatport'] = 'E corre polo porto: ';
$string['orderoftestsexecution'] = 'Orde de execución das probas';
$string['pendingexecutiontest'] = 'Agardando a que remate a proba anterior';
$string['generictesterror'] = 'Esta proba rematou cun erro porque a proba anterior non se puido executar ou rematou cun erro.';
$string['pendingtest'] = 'Proba pendentet ...';
$string['notusecertificates'] = 'Non utilizas certificados SSL. Se non o fai adrede, recomendámoslle o seu uso.';
$string['notmakeaconnection'] = '+info: O teu navegador non pode conectar co teu servidor websocket, comprobar o URL ou o porto.';
