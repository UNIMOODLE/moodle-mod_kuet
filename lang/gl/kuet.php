...
$string['protocolnotvalid'] = 'HTTP ou HTTPS é obrigatorio e recoméndase encarecidamente o uso do protocolo HTTPS na plataforma para usar Kuet.';
$string['sessionsnum'] = 'Número de sesións';
$string['validopenconnection'] = 'Conexión válida cun servidor WebSocket.';
$string['invalidconnection'] = 'Erro na conexión do servidor WebSocket. Comproba os erros na túa consola.';
$string['tests'] = 'Proba';
