...
$string['protocolnotvalid'] = 'HTTP o HTTPS és obligatori, i HTTPS és molt recomanable per emprar el mòdul de Kuet.';
...
$string['invalidconnection'] = 'No es pot establir la connixió amb el servidor de WebSocket. Revisa la cònsola per sabre més informació.';
$string['tests'] = 'Test';
...
$string['ssltest_description'] = 'Revisa si el certificat SSL és vàlid';
