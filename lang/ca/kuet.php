...
$string['httpsrecommended'] = 'Estas emprant el protocol HTTP. Si el teu entorn és de producció es molt recomenable canviar-lo per HTTPS.';
$string['protocolnotvalid'] = 'S\'ha d\'emprar HTTP o HTTPS, i usar HTTPS és molt recomanable per emprar el mòdul de Kuet.';
...
$string['validopenconnection'] = 'Connexió establerta amb el servidor de WebSocket.';
$string['invalidconnection'] = 'No es pot establir la connixió amb el servidor de WebSocket. Investiga si la url és correcte, o bé revisa que el teu port està obert i accepta connexions.';
$string['tests'] = 'Test';
$string['results'] = 'Resultat';
$string['protocoltest'] = 'Protocol';
$string['protocoltest_description'] = 'Revisa si s\'empra el protocol http o https';
$string['ssltest'] = 'Certificat SSL';
$string['ssltest_description'] = 'Comprova que el certificat SSL és vàlid';
$string['openconnectiontest'] = 'Connexió amb el servidor de WebSocket';
$string['openconnectiontest_description'] = 'Revisa si els teus usuaris poden establir connexió amb el servidor de WebSocket';
$string['test_info'] = 'Informació sobre les proves';
$string['test_description'] = 'Qué revisa';
$string['extra_info'] = 'Informació addicional (si escau)';
$string['userconnectionsonrisk'] = 'Els teus usuaris estan en perill degut a que les connexions no estan xifrades.';
$string['sendmessagetest'] = 'Enviar un missatge';
$string['sendmessagetest_description'] = 'Envia un missatge al servidor de WebSocket';
$string['validsendedtest'] = 'El missatge s\'ha enviat correctament.';
$string['invalidsendedtest'] = 'El missatge no s\'ha pogut enviar';
$string['receivemessagetest'] = 'Rebre el missatge de resposta';
$string['receivemessagetest_description'] = 'Rebre el missatge de resposta del servidor de WebSocket';
$string['validreceivedtest'] = 'El missatge s\'ha rebut correctament.';
$string['invalidreceivedtest'] = 'No s\'ha rebut el missatge de resposta';
$string['nodatareceivedtest'] = 'Sembla que la connectivitat entre el servidor de WebSocket i els teus usuaris té qualque problema.';
$string['socketurl'] = 'La url del servidor de WebSocket és: ';
$string['runatport'] = 'I està escoltant al port: ';
$string['orderoftestsexecution'] = 'Ordre de les proves';
$string['pendingexecutiontest'] = 'Esperant a que el test anterior acabi';
$string['generictesterror'] = 'Aquesta prova ha acabat en error perquè la prova anterior, o bé ha acabat en error, o bé no s\'ha pogut executar.';
$string['pendingtest'] = 'Prova pendent ...';
$string['notusecertificates'] = 'No estàs emprant certificat SSL. Si no ho fas a dretacent, per favor, es recomana el seu us.';
$string['notmakeaconnection'] = '+info: Des de el teu navegador no es pot establir connexió amb el servidor de websocket, per favor, revisar la url o el port.';
