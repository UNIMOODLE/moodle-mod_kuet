...
$string['httpsrecommended'] = 'Estás usando el protocolo HTTP. Si no lo haces adrede, se recomienda encarecidamente usar HTTPS.';
$string['protocolnotvalid'] = 'Deben usarse los protocolos HTTP o HTTPS, y se recomienda usar HTTPS para utilizar este módulo.';
$string['validopenconnection'] = 'Conexión establecida de forma correcta con el servidor de WebSocket.';
$string['invalidconnection'] = 'Sus usuarios no pueden establecer una conexión válida con su servidor WebSocket. Investiga si tu url es válida o sondea si tu puerto está abierto y acepta conexiones.';
$string['tests'] = 'Test';
$string['results'] = 'Resultado';
$string['protocoltest'] = 'Protocolo';
$string['protocoltest_description'] = 'Revisa si el protocol que estas usando es http o https';
$string['ssltest'] = 'Certificado SSL';
$string['ssltest_description'] = 'Comprueba que el certificado SSL sea valido';
$string['openconnectiontest'] = 'Conexión con el servidor de WebSocket';
$string['openconnectiontest_description'] = 'Revisa si los usuarios pueden conectarse al servidor de WebSocket';
$string['test_info'] = 'Información de los tests';
$string['test_description'] = 'Qué revisa';
$string['extra_info'] = 'Información adicional (si procede o existe)';
$string['userconnectionsonrisk'] = 'Tus usuarios están en riesgo ya que sus conexiones no son seguras por no usar un certificado SSL. Si no lo haces adrede, por favor, recomendamos su uso.';
$string['sendmessagetest'] = 'Enviar un mensaje';
$string['sendmessagetest_description'] = 'Enviar un mensaje al servidor de WebSocket';
$string['validsendedtest'] = 'El mensaje ha sido enviado correctamente.';
$string['invalidsendedtest'] = 'No se puede enviar el mensaje';
$string['receivemessagetest'] = 'Mensaje recibido de forma correcta';
$string['receivemessagetest_description'] = 'Recibir el mensaje de respuesta del servidor de WebSocket';
$string['validreceivedtest'] = 'El mensaje se ha recibido de forma correcta.';
$string['invalidreceivedtest'] = 'No se ha recibido el mensaje de respuesta';
$string['nodatareceivedtest'] = 'Parece que la conexión entre el servidor y tus usuarios tiene algún tipo de problema.';
$string['socketurl'] = 'La url del servidor de WebSocket es: ';
$string['runatport'] = 'Y se está escuchando en el puerto: ';
$string['orderoftestsexecution'] = 'Orden de las pruebas';
$string['pendingexecutiontest'] = 'Esperando a que el test anterior acabe';
$string['generictesterror'] = 'Este test ha terminado con error porqué el test anterior, o bien no se ha podido efectuar, o bien ha terminado con un error.';
$string['pendingtest'] = 'Prueba pendiente ...';
$string['notusecertificates'] = 'No estás usando certificado SSL. Si no lo haces a propósito, se recomienda su uso.';
$string['notmakeaconnection'] = '+info: Desde tu navegador no se puede establecer la conexión con el servidor de websocket, por favor, revisa la url o el puerto.';
