...
$string['kuet_header'] = 'Configuración Kuet';
...
$string['teamsgradeheader'] = 'Calificación por equipos';
$string['teamgrade'] = 'Calificación del equipo';
$string['teamgrade_help'] = 'Forma para calificar a cada miembro del equipo.';
...
$string['generalsettings'] = 'Conifguración General';
...
$string['advancemode'] = 'Modo avance';
...
$string['openquiz'] = 'Abrir el cuestionario';
$string['openquizenable'] = 'Habilitar';
$string['startdate'] = 'Fecha de inicio de sesión';
$string['closequiz'] = 'Cerrar cuestionario';
...
$string['end_session'] = 'Finalizar sesióm';
...
$string['anonymiseallresponses'] = 'Anonimizar completamente las respuestas de los estudiantes';
...
$string['copyquestion_desc'] = '¿Estás seguro que quieres copiar esta pregunta de la sesión?';
$string['questionnameheader'] = 'Nombre de la pregunta: "{$a}"';
$string['questiontime'] = 'Tiempo de pregunta';
$string['notimelimit'] = 'Sin limite de tiempo';
...
$string['onlyinactivemodevalid'] = 'Sólo el modo inactivo es válido con el modo de avnace manual';
...
$string['anonymousanswer_help'] = 'El profesor no sabrá quién está contestando las preguntas';
...
$string['exitquestion_desc'] = 'Si sales de la pregunta, se marcará como no respondida. ¿Estás seguro que quieres salir?';
...
$string['team_grade_average'] = 'Media de las respuestas';
$string['groupingid_not_selected'] = 'En el modo grupos, se debe seleccionar un agrupamiento';
...
$string['session_groupings_no_groups'] = 'El agrupamiento está vacio. Por favor, selecciona una agrupamiento con grupos.';
...
$string['fakegroupdescription'] = 'La actividad Kuet ha creado este grupo porque hay participantes en este curso que no pertenecen a ningun grupo selecionado.';
...
$string['nogroupingscreated'] = 'Esta actividad está en modo grupos pero no hay agrupamientos creados en este curso. Es necesario que crees un agrupamiento para poderlo elegir en la actividad.';
$string['notallowedspecialchars'] = 'No se permiten caracteres especiales: ?!<>\\';
$string['notallowedpasting'] = 'No se permite copiar texto';
