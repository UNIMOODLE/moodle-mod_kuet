...
$string['httpsrecommended'] = 'Estás usando el protocolo HTTP. Si tu servidor es el de producción, es muy importante que lo cambies a HTTPS.';
$string['protocolnotvalid'] = 'HTTP o HTTPS es obligatorio, y HTTPS debería usarse para este módulo.';
$string['validopenconnection'] = 'Conexión establecida de forma correcta con el servidor de WebSocket.';
$string['invalidconnection'] = 'Hay algún problema con la conxión con el servidor de WebSocket. Revisa la consola de errores.';
$string['tests'] = 'Test';
$string['results'] = 'Resultado';
$string['protocoltest'] = 'Protocolo';
$string['protocoltest_description'] = 'Revisa si el protocol que se usa es http o https';
$string['ssltest'] = 'Certificado SSL';
$string['ssltest_description'] = 'Revisa si el certificado SSL es valido';
...
$string['userconnectionsonrisk'] = 'Tus usuarios están en riesgo ya que sus conexiones no son seguras.';
$string['sendmessagetest'] = 'Enviar un mensaje';
$string['sendmessagetest_description'] = 'Enviar un mensaje al servidor de WebSocket';
$string['validsendedtest'] = 'En mensaje ha sido enviado correctamente.';
