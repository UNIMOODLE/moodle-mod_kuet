...
$string['runatport'] = 'And runs on the port: ';
$string['score'] = 'Score';
...
$string['serveroffline'] = 'WebSocket server offline. <a href="./testssl.php?action=start">Try to start</a>';
$string['serverpid'] = 'Local WebSocket server proc.';
$string['serverpid_desc'] = 'Server process {$a->pid} at {$a->server}';
$string['serverrunning'] = 'WebSocket server is running with pid {$a}  <a href="./testssl.php?action=stop">Kill server</a>';
