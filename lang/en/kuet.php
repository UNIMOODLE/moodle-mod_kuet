...
$string['sessionmanualactivated'] = 'The session {$a->sessionid} is active in kuetid -> {$a->jqshowid}. The remainder of the session is omitted until the end of this session.';
$string['sessionactivated'] = 'Session {$a->sessionid} activated for kuetid {$a->jqshowid}';
$string['sessionfinished'] = 'Session {$a->sessionid} finished for kuetid {$a->jqshowid}';
$string['sessionfinishedformoreone'] = 'Session {$a->sessionid} finished for kuetid {$a->jqshowid} because more than one session is active.';
