...
$string['httpsrecommended'] = 'You use HTTP protocol. It is highly recommended to use https protocol on PRODUCTION environments.';
$string['protocolnotvalid'] = 'HTTP or HTTPS is mandatory, and HTTPS protocol is strongly recommended to use on the platform to use Kuet.';
$string['sessionsnum'] = 'Number of sessions';
$string['validopenconnection'] = 'Valid connection with a WebSocket server.';
$string['invalidconnection'] = 'Error on WebSocket server connection. Check errors on your console.';
$string['tests'] = 'Test';
...
$string['ssltest_description'] = 'Check if SSL certificate is valid';
$string['openconnectiontest'] = 'Connection with WebSocket server';
$string['openconnectiontest_description'] = 'Check if your users can stablish connection with WebSocket server';
