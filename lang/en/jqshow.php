...
$string['allowguests_help'] = 'This session can be used by guests users';
$string['sessionmode_help'] = 'Session modes show different ways to use jqshow sessions.';
$string['countdown_help'] = 'countdown help';
...
$string['activetimelimit_help'] = 'Enable a total sesion time';
