...
$string['showfeedback_help'] = 'After answering each question a feedback will be appeared. (Only if the question contains feedbacks).';
...
$string['sessionconflict'] = 'This session has a date conflict with other sessions closer to it, and will not start automatically.';
