...
$string['copyquestion'] = 'Copia una pregunta de la sessió';
$string['copyquestion_desc'] = 'Esteu segur de copiar aquesta pregunta de la sessió?';
$string['questionnameheader'] = 'Nom de la pregunta: "{$a}"';
$string['notimelimit'] = 'Sense límit de temps';
...
$string['programmedmode'] = 'Programat';
$string['inactivemode'] = 'Inactiu';
...
$string['points'] = 'Punts';
$string['onlyinactivemodevalid'] = 'Només el mode de joc inactiu és vàlid amb el mode avançat manual.';
...
$string['exitquestion'] = 'Surt de la pregunta';
$string['exitquestion_desc'] = 'Si deixeu la pregunta, es marcarà com a sense resposta. Estàs segur que vols marxar?';
...
$string['statement'] = 'Declaració';
$string['preview'] = 'Vista prèvia';
$string['correct_answers'] = 'Respostes correctes';
...
$string['response_number'] = 'Nº de respostes';
$string['average_time'] = 'Temps mitjà';
...
$string['session_gm_disabled'] = 'Inhabilitat';
$string['session_gm_position'] = 'Valoració relativa a la situació del rànquing: [participants – posició + 1]/[participants] * 100%';
$string['session_gm_position_short'] = '[participants – posició + 1]/[participants] * 100%';
$string['session_gm_points'] = 'Valoració relativa als punts obtinguts: [puntuació]/[puntuació màxima] * 100%';
$string['session_gm_points_short'] = '[puntuació]/[puntuació màxima] * 100%';
$string['session_gm_combined'] = 'Valoració mitjana entre la qualificació relativa a la situació de rànquing i la qualificació relativa als punts obtinguts.';
$string['session_gm_combined_short'] = 'Mitjana entre la situació de rànquing i els punts obtinguts.';
...
$string['team_grade_first'] = 'Primera resposta';
$string['team_grade_last'] = 'Última resposta';
$string['team_grade_average'] = 'Resposta mitjana';
$string['groupingid_not_selected'] = 'En el mode de grup, s\'ha de seleccionar una agrupació';
...
$string['session_groupings_no_groups'] = 'l\'agrupació és buida. Si us plau, seleccioneu una agrupació amb participants del grup.';
...
$string['nogroupingscreated'] = 'Cal que en primer lloc creeu un agrupament en aquest curs per poder escollir-lo en aquesta activitat.';
$string['notallowedspecialchars'] = 'No es permeten caràcters especials: ?!<>\\';
$string['notallowedpasting'] = 'No es permet enganxar text';
