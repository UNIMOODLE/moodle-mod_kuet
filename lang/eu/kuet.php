...
$string['kuet_header'] = 'Kuet ezarpenak';
...
$string['teamsgradeheader'] = 'Taldeen kalifikazioa';
$string['teamgrade'] = 'Taldeen kalifikazioa';
$string['teamgrade_help'] = 'Hau da taldekide bakoitza kalifikatzeko modua.';
$string['chooseoption'] = 'Aukeratu aukera bat';
...
$string['sslcertificates'] = 'SSL ziurtagiriak';
...
$string['socketclosed'] = 'Entxufea itxita';
...
$string['advancemode'] = 'Modu aurreratua';
$string['gamemode'] = 'Joko modua';
...
$string['openquiz'] = 'Ireki galdetegia';
$string['openquizenable'] = 'Gaitu';
$string['startdate'] = 'Saioaren hasiera data';
$string['closequiz'] = 'Ireki galdetegia';
$string['closequizenable'] = 'Gaitu';
...
$string['anonymiseallresponses'] = 'Erabat anonimizatu ikasleen erantzunak';
...
$string['copyquestion'] = 'Kopiatu saioko galdera bat';
$string['copyquestion_desc'] = 'Ziur al zaude galdera hau saiotik kopiatzeaz?';
$string['questionnameheader'] = 'Galderaren izena: "{$a}"';
$string['questiontime'] = 'Galderen ordua';
...
$string['manualmode'] = 'Eskuliburua';
$string['programmedmode'] = 'Programatua';
$string['inactivemode'] = 'Inaktibo';
$string['racemode'] = 'Lasterketa';
$string['podiummode'] = 'Podiuma';
...
$string['onlyinactivemodevalid'] = 'Joko inaktiboen moduak soilik balio du eskuzko aurrerapen moduarekin.';
...
$string['exitquestion'] = 'Irten galderatik';
$string['exitquestion_desc'] = 'Galdera utziz gero, erantzun gabe bezala markatuko da. Ziur alde egin nahi duzula?';
...
$string['statement'] = 'Adierazpena';
$string['preview'] = 'Aurrebista';
$string['correct_answers'] = 'Erantzun zuzenak';
...
$string['response_number'] = 'Erantzun kopurua';
$string['average_time'] = 'Batez besteko denbora';
...
$string['session_gm_disabled'] = 'Desgaituta';
$string['session_gm_position'] = 'Ranking-eko egoeraren balorazioa: [parte-hartzaileak – postua + 1]/[parte-hartzaileak] * % 100';
$string['session_gm_position_short'] = '[parte-hartzaileak – postua + 1]/[parte-hartzaileak] * % 100';
$string['session_gm_points'] = 'Lortutako puntuen balorazioa: [puntuazioa]/[gehieneko puntuazioa] * % 100';
$string['session_gm_points_short'] = '[puntuazioa]/[gehienezko puntuazioa] * % 100';
$string['session_gm_combined'] = 'Batez besteko balorazioa sailkapen-egoeraren eta lortutako puntuen arteko balorazioa.';
$string['session_gm_combined_short'] = 'Ranking-egoeraren eta lortutako puntuen arteko batez bestekoa.';
...
$string['team_grade_first'] = 'Lehenengo erantzuna';
$string['team_grade_last'] = 'Azken erantzuna';
$string['team_grade_average'] = 'Batez besteko erantzuna';
$string['groupingid_not_selected'] = 'Talde moduan, taldekatze bat hautatu behar da';
$string['session_groupings_error'] = 'Jarduera hau talde moduan ezarrita dago. Saio bakoitzak taldekatze bat hautatu behar du.';
$string['session_groupings_no_groups'] = 'Taldekatzea hutsik dago. Mesedez, hautatu talde parte-hartzaileekin taldekatzea.';
...
$string['nogroupingscreated'] = 'Ikastaro honetan taldekatze bat sortzea beharrezkoa da jarduera honetan aukeratu ahal izateko.';
$string['notallowedspecialchars'] = 'Ez da karaktere berezirik onartzen: ?!<>\\';
$string['notallowedpasting'] = 'Ezin da testua itsatsi';
