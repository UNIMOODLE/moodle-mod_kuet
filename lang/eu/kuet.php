...
$string['protocolnotvalid'] = 'HTTP edo HTTPS erabili behar da, eta HTTPS protokoloa guztiz gomendatzen da plataforman erabiltzea Kuet exekutatzeko.';
$string['sessionsnum'] = 'Saio kopurua';
$string['validopenconnection'] = 'Baliozko konexioa WebSocket zerbitzari batekin.';
$string['invalidconnection'] = 'Zure erabiltzaileek ezin dute baliozko konexiorik egin WebSocket zerbitzariarekin. Ikertu zure URLa baliozkoa den edo ikertu zure ataka irekita dagoen eta onartu konexioak.';
$string['tests'] = 'Proba';
...
$string['socketurl'] = 'WebSocket-en zerbitzariaren url-a da: ';
$string['runatport'] = 'Eta portuan doa: ';
$string['orderoftestsexecution'] = 'Probak egiteko ordena';
$string['pendingexecutiontest'] = 'Aurreko proba bukatzeko zain';
$string['generictesterror'] = 'Proba hau errore batekin amaitu da, aurreko proba ezin izan delako exekutatu edo errore batekin amaitu delako.';
$string['pendingtest'] = 'Proba zain ...';
$string['notusecertificates'] = 'Ez duzu SSL ziurtagiririk erabiltzen. Nahita egiten ez baduzu, erabiltzea gomendatzen dizugu.';
$string['notmakeaconnection'] = '+info: Zure arakatzaileak ezin du zure websocket zerbitzariarekin konexiorik egin, URL edo ataka egiaztatu.';
