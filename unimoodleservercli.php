...
define('unimoodleservercli', value: "UNIMOODLEKUET");
...
class websocketuser {
     ...
     */
    public $picture = '';
    public $sendingContinuous = false; // If true, then the next message sent will be a continuous message.
    /**
     * Constructor
     *
     * @param $id
